 ...
 */
package ccc.android.meterreader.qrreading;

import java.util.Collections;
import java.util.List;

import ccc.android.meterreader.*;
...
//    	else
//    		return inflater.inflate(ccc.android.meterreader.R.layout.camerapreview, container);
    }
    ...
    PreviewCallback previewCb = new PreviewCallback() 
    {
        public void onPreviewFrame(byte[] data, Camera camera) {
				...
				if (result != 0) {
					...
					for (Symbol sym : syms) {
						Intent i = new Intent(Statics.ANDROID_INTENT_ACTION_GID).putExtra("barcode", sym.getData());
